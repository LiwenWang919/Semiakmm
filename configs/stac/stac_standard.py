...
total_iter = 40000
total_image = 118287
unlabeled_image = int(total_image * (100 - percent) / 100)
total_epoch = 400
update_epoch = total_epoch
test_interval = 2000
save_interval = 10000
# # -------------------------dataset------------------------------
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        pipeline_u=pipeline_u, pipeline_u_1=None,
...
stac_hook_cfg = dict(
    ...
    workers_per_gpu=4,
    score_thr=score,
    evaluation=dict(interval=total_epoch, metric='bbox', by_epoch=True),
    # data=dict(
...
custom_hooks = [
    ...
    dict(type='STACHook', cfg=stac_hook_cfg)
]
