...
data_root = './fetus_annotations_coco/Dataset_For_NIPS_DB_Track/NT/'
ann_root = './fetus_annotations_coco/Dataset_For_NIPS_DB_Track/NT/'
data = dict(
    ...
    train=dict(
        type='SemiDataset',
        classes = classes,
        ann_file=ann_root + 'train_label_10_annotation.json',
        ann_file_u=ann_root + 'train_unlabel_10_annotation.json',
